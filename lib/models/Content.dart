...
class Content extends amplify_core.Model {
  ...
  const Content._internal({required this.id, required name, required weight, required type, createdAt, updatedAt}): _name = name, _weight = weight, _type = type, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Content({String? id, required String name, required double weight, required int type}) {
  ...
  Content copyWith({String? name, double? weight, int? type}) {
    return Content._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'weight': _weight, 'type': _type, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
